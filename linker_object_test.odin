...
test_linker_object_text_with_symbol :: proc(t: ^testing.T) {
    ...
    testing.expect(t, active_section != nil)
    testing.expect(t, active_section == &object.text_sections[0])
    testing.expect_value(t, string(object.text_sections[0].string_table[:]), "symbol\x00")
}
...
test_linker_object_data_with_symbol :: proc(t: ^testing.T) {
    ...
    testing.expect(t, active_section != nil)
    testing.expect(t, active_section == &object.data_sections[0])
    testing.expect_value(t, string(object.data_sections[0].string_table[:]), "symbol\x00")
}
